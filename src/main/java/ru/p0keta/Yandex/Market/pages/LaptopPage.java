...
public class LaptopPage extends MainPage {
    ...
    protected static final By btnGetAll = By.xpath("//button[@class='_2AXg- _1yYg9']//span[text()='Показать всё']");
    protected static final By inputModel = By.xpath("//input[@class='IPqfg']");
